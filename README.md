...
Before building Sage Aasvogel, you first need to have built a proper cross compiler for the `i686-elf` platform. The tested development environment uses GCC 4.7.4 and GNU Binutils 2.24. The `i686-elf-gcc`, `i686-elf-as`, and `i686-elf-ld` commands must also be in your `PATH` environment variable.
